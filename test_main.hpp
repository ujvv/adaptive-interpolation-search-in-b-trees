...
enum Btrees { ANALYSIS, TEST, 
            BINARYSEARCH, BINARYSEARCHBIGNODE, BINARYSEARCHNOPREFIX, BINARYSEARCHWITHHINTS, 
            INTERPOLATIONSEARCH, INTERPOLATIONSEARCHBIGNODE, INTERPOLATIONSEARCHWITHKEYHEADS, INTERPOLATIONSEARCHWITHKEYHEADSBIGNODE, 
            ADAPTIVESEARCH, IBS, SIP, SIPBIGNODE, TIP, ISS, ISSBIGNODE,
            LINEARSEARCH, LINEARSEARCHBIGNODE, TEMPLATE, TEMPLATEBIGNODE, MAP};
